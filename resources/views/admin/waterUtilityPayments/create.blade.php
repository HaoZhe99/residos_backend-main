...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} Water Utility Payment
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.water-utility-payments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_meter') ? 'is-invalid' : '' }}" type="number" name="last_meter" id="last_meter" value="{{ old('last_meter', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('this_meter') ? 'is-invalid' : '' }}" type="number" name="this_meter" id="this_meter" value="{{ old('this_meter', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prev_consume') ? 'is-invalid' : '' }}" type="number" name="prev_consume" id="prev_consume" value="{{ old('prev_consume', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('this_consume') ? 'is-invalid' : '' }}" type="number" name="this_consume" id="this_consume" value="{{ old('this_consume', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('variance') ? 'is-invalid' : '' }}" type="number" name="variance" id="variance" value="{{ old('variance', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\WaterUtilityPayment::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', 'outstanding') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
