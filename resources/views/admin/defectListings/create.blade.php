...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.defectListing.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.defect-listings.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="case_code">{{ trans('cruds.defectListing.fields.case_code') }}</label>
                <input class="form-control {{ $errors->has('case_code') ? 'is-invalid' : '' }}" type="text" name="case_code" id="case_code" value="{{ old('case_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('incharge_person') ? 'is-invalid' : '' }}" type="text" name="incharge_person" id="incharge_person" value="{{ old('incharge_person', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor') ? 'is-invalid' : '' }}" type="text" name="contractor" id="contractor" value="{{ old('contractor', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('status_control') ? 'is-invalid' : '' }}" name="status_control_id" id="status_control_id">
                    @foreach($status_controls as $id => $status_control)
                        <option value="{{ $id }}" {{ old('status_control_id') == $id ? 'selected' : '' }}>{{ $status_control }}</option>
                    @endforeach
                </select>
