...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.visitorControl.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.visitor-controls.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('favourite') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="favourite" id="favourite" value="1" {{ old('favourite', 0) == 1 ? 'checked' : '' }}>
