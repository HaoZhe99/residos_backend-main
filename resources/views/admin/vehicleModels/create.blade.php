    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicle-models.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('series') ? 'is-invalid' : '' }}" type="text" name="series" id="series" value="{{ old('series', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('release_year') ? 'is-invalid' : '' }}" type="text" name="release_year" id="release_year" value="{{ old('release_year', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seat_capacity') ? 'is-invalid' : '' }}" type="number" name="seat_capacity" id="seat_capacity" value="{{ old('seat_capacity', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wheel_base') ? 'is-invalid' : '' }}" type="text" name="wheel_base" id="wheel_base" value="{{ old('wheel_base', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kerb_weight') ? 'is-invalid' : '' }}" type="text" name="kerb_weight" id="kerb_weight" value="{{ old('kerb_weight', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel_tank') ? 'is-invalid' : '' }}" type="text" name="fuel_tank" id="fuel_tank" value="{{ old('fuel_tank', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('front_brake') ? 'is-invalid' : '' }}" type="text" name="front_brake" id="front_brake" value="{{ old('front_brake', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rear_brake') ? 'is-invalid' : '' }}" type="text" name="rear_brake" id="rear_brake" value="{{ old('rear_brake', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('front_suspension') ? 'is-invalid' : '' }}" type="text" name="front_suspension" id="front_suspension" value="{{ old('front_suspension', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rear_suspension') ? 'is-invalid' : '' }}" type="text" name="rear_suspension" id="rear_suspension" value="{{ old('rear_suspension', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('steering') ? 'is-invalid' : '' }}" type="text" name="steering" id="steering" value="{{ old('steering', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine_cc') ? 'is-invalid' : '' }}" type="text" name="engine_cc" id="engine_cc" value="{{ old('engine_cc', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('compression_ratio') ? 'is-invalid' : '' }}" type="text" name="compression_ratio" id="compression_ratio" value="{{ old('compression_ratio', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peak_power_bhp') ? 'is-invalid' : '' }}" type="text" name="peak_power_bhp" id="peak_power_bhp" value="{{ old('peak_power_bhp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peak_torque_nm') ? 'is-invalid' : '' }}" type="text" name="peak_torque_nm" id="peak_torque_nm" value="{{ old('peak_torque_nm', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('engine_type') ? 'is-invalid' : '' }}" type="text" name="engine_type" id="engine_type" value="{{ old('engine_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel_type') ? 'is-invalid' : '' }}" type="text" name="fuel_type" id="fuel_type" value="{{ old('fuel_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('driven_wheel_drive') ? 'is-invalid' : '' }}" type="text" name="driven_wheel_drive" id="driven_wheel_drive" value="{{ old('driven_wheel_drive', '') }}">
