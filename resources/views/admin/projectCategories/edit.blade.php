    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.project-categories.update", [$projectCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_category') ? 'is-invalid' : '' }}" type="text" name="project_category" id="project_category" value="{{ old('project_category', $projectCategory->project_category) }}" required>
