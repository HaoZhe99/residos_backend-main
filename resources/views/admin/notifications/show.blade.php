        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.userAlert.fields.alert_text_zh') }}
                        </th>
                        <td>
                            {{ $userAlert->alert_text_zh }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.userAlert.fields.alert_text_en') }}
                        </th>
                        <td>
                            {{ $userAlert->alert_text_en }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                            {{ trans('cruds.userAlert.fields.alert_text_ms') }}
                        </th>
                        <td>
                            {{ $userAlert->alert_text_ms }}
                        </td>
                    </tr>
                    <tr>
                        <th>
