    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.event-listings.update", [$eventListing->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_code') ? 'is-invalid' : '' }}" type="text" name="event_code" id="event_code" value="{{ old('event_code', $eventListing->event_code) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('catogery') ? 'is-invalid' : '' }}" name="catogery_id" id="catogery_id" required>
                    @foreach($catogeries as $id => $catogery)
                        <option value="{{ $id }}" {{ (old('catogery_id') ? old('catogery_id') : $eventListing->catogery->id ?? '') == $id ? 'selected' : '' }}>{{ $catogery }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $eventListing->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $eventListing->description) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment') ? 'is-invalid' : '' }}" type="text" name="payment" id="payment" value="{{ old('payment', $eventListing->payment) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participants') ? 'is-invalid' : '' }}" type="number" name="participants" id="participants" value="{{ old('participants', $eventListing->participants) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organized_by') ? 'is-invalid' : '' }}" type="text" name="organized_by" id="organized_by" value="{{ old('organized_by', $eventListing->organized_by) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $eventListing->type) }}">
                @if($errors->has('type'))
                    <div class="invalid-feedback">
                        {{ $errors->first('type') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\EventListing::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $eventListing->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('created_by') ? 'is-invalid' : '' }}" name="created_by_id" id="created_by_id">
                    @foreach($created_bies as $id => $created_by)
                        <option value="{{ $id }}" {{ (old('created_by_id') ? old('created_by_id') : $eventListing->created_by->id ?? '') == $id ? 'selected' : '' }}>{{ $created_by }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_group') ? 'is-invalid' : '' }}" name="user_group_id" id="user_group_id">
                    @foreach($user_groups as $id => $user_group)
                        <option value="{{ $id }}" {{ (old('user_group_id') ? old('user_group_id') : $eventListing->user_group->id ?? '') == $id ? 'selected' : '' }}>{{ $user_group }}</option>
                    @endforeach
                </select>
