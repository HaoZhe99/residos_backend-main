...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} Term And Policy
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.term-and-policies.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('details_zh') ? 'is-invalid' : '' }}" name="details_zh" id="details_zh">{!! old('details_zh') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('details_en') ? 'is-invalid' : '' }}" name="details_en" id="details_en">{!! old('details_en') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('details_ms') ? 'is-invalid' : '' }}" name="details_ms" id="details_ms">{!! old('details_ms') !!}</textarea>
