...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.eBillListing.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.e-bill-listings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @endif
                {{-- <span class="help-block">payment_method</span> --}}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime{{ $errors->has('expired_date') ? 'is-invalid' : '' }}" type="text" name="expired_date" id="expired_date" value="{{ old('expired_date', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bank_acc') ? 'is-invalid' : '' }}" name="bank_acc_id" id="bank_acc_id" required>
                    @foreach($bank_accs as $id => $bank_acc)
                        <option value="{{ $id }}" {{ old('bank_acc_id') == $id ? 'selected' : '' }}>{{ $bank_acc }}</option>
                    @endforeach
                </select>
