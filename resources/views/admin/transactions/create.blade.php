    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bill_code') ? 'is-invalid' : '' }}" type="text" name="bill_code" id="bill_code" value="{{ old('bill_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit') ? 'is-invalid' : '' }}" type="text" name="credit" id="credit" value="{{ old('credit', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('debit') ? 'is-invalid' : '' }}" type="text" name="debit" id="debit" value="{{ old('debit', '') }}">
                @if($errors->has('debit'))
                    <div class="invalid-feedback">
                        {{ $errors->first('debit') }}
                    </div>
